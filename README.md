...
> [!NOTE]
> For the same examples in Python, see
> [mda-examples-python](https://github.com/christian-bromann/mda-examples-python).
...
| [`repo-pulse/`](./repo-pulse)                   | **Repo Pulse** — GitHub maintainer analytics via baked `gh` CLI; private Docker Hub image + managed `registry` + chart UI |
...
| `MDA_GITHUB_TOKEN`           | for GitHub (`daily-update` tools; `repo-pulse` `gh` auth) |
